<x-app-layout>
    ...
    <div class="py-12">
        <form class="smart-form" action="{{ route('customerRequests.'.($url??'byOperationDetail'),$id??'') }}" method="get" enctype="multipart/form-data">
            <div class="row-5">
            ...
            <div class="row-5">
                ...
                <div class="row-3">
                    ...
                    <div class="form-group">
                        <label style="color: transparent">-</label>
                        <a href="{{ route('customerRequests.'.($url??'byOperationDetail')) }}" class="btn btn-worn">إعادة تعيين</a>
                    </div>

                    <div class="form-group">
                        <label style="color: transparent">-</label>
                        <a href="{{ route('customerRequests.' . ($urlPrint ?? 'byStoreDetailPrint'), array_merge(['id' => $id ?? ''], request()->query())) }}" class="btn btn-secondary">
                            طباعة
                        </a>
                    </div>
                </div>
