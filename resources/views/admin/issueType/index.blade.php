<x-app-layout>
    ...
    <div class="py-12">
        <div class="add btn">
            <a href="{{route('issuesType.add')}}">اضافة <i class="fa-solid fa-plus"></i></a>
        </div>
                    ...
                    @foreach($issueTypes as $issueType)
                        <tr>
                            ...
                            <td>
                                ...
                                <td >
                                    <div class="actions">
                                        @if(Auth::user()->permissions('general-issues')?->can_update == 1)
                                        <a href="{{route('issuesType.edit',$issueType->id)}}" class="btn btn-worn">تعديل</a>
                                        @endif
                                            @if(Auth::user()->permissions('general-issues')?->can_delete == 1)
