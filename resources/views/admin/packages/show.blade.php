...
$modelTranslations = [
    ...
    'ratings'   => '   التقييم',
    'sales_routs'   => '   الخطوط',
    'customersRequests'   => '   طلبات المندوبين',
            ...
            <div class="report-container">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <span class="info-content">{{ $package->name ?? '—' }}</span>
                    </div>
                    <div class="info-card">
                        <span class="info-title">الوصف</span>
                        <span class="info-content">{{ $package->description ?? '—' }}</span>
                    </div>
                    <div class="info-card">
                        <span class="info-title">عدد النماذج</span>
                        <span class="info-content">{{ $package->templates->count() }}</span>
                    </div>
                </div>
                ...
                <div class="mt-6">
                    <a href="{{ route('packages.index') }}" class="btn-back">العودة للحزم</a>
                    <a href="{{ route('packages.edit', $package->id) }}" class="btn-show ml-2">تعديل الحزمة</a>
                </div>
