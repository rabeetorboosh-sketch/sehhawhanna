                        ...
                        @foreach($controlUnit as $pro)
                            <div class="grp{{$pro->department_id}}  minGrb{{$pro->main_group_id}} subGroup{{$pro->sub_group_id}} item-container"  >
                                ...
                                <div class="flex space-x-4">
                                    <label>جيد</label>
                                    <input type="checkbox" data-text="{{$pro->id}}" name="is_correct[{{$pro->id}}]" value="1" class="  correct" >
                                </div>
                                <textarea name="issue_text[{{ $pro->id }}] " class="txt{{$pro->id}}">  </textarea>
                                ...
                                <div class="items itm{{$pro->id}}">
                                    ...
                                    <div class="save-container">
                                        <span class="items-save" data-text="{{$pro->id}}">
                                            حفظ
                                        </span>
                                    </div>
                                </div>
                            ...
                            "><i class="fas fa-camera"></i> إضافة صورة
                                ...
                                @if($pro->has_photos == 2)
                                    ...
                                    <div id="multi-images-{{$pro->id}}" style="margin-top: 1px;">
                                        <input type="file" accept="image/*" name="images[{{ $pro->id }}][]" id="images-{{$pro->id}}" class="hidden" >
