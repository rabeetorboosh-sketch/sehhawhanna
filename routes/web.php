...
use App\Http\Controllers\Pur\PurIntakeController;
...
//-///-/-//-/-/-/-/-/--/-/--/
    ...
    Route::resource('intake', PurIntakeController::class);
    Route::post('purchaseIntake/{purchaseIntake}/confirm', [PurIntakeController::class, 'confirm'])->name('intake.confirm');
    Route::get('purchaseIntake/buy/{purchase}', [PurIntakeController::class, 'buy'])->name('intake.buy');
